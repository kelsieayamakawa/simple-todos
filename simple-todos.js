...
if (Meteor.isClient) {
  ...
  Template.body.helpers({
     ...
     * Does not display any hidden tasks
  ...
  Template.body.events({
     ...
     * @param event The browser event when a user clicks to create a new task.
     */
    ...
    /**
     * Set the state of the hideCompleted session variable.
  ...
  Template.task.events({
    ...
    /**
     * Set the current task to private.
     */
...
Meteor.methods({
   ...
   * Private tasks can only be updated by their owner.
  ...
  /**
   * Allows the owner of a task to set the private status.
   * @param taskId The task ID.
